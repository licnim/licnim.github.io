...
ggplot(data, aes(x = Followers)) + geom_boxplot() + dark_theme_gray() + theme(plot.background = element_rect(fill = "grey10")) + labs(title = "Plot of Number of Followers on Idols' Instagram Accounts (n = 406)", x = "Followers") + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
  scale_x_continuous(
